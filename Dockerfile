...
LABEL ca.unb.lib.generator="postgres" \
  org.opencontainers.image.title="digitalrepository.postgres.lib.unb.ca" \
  org.opencontainers.image.description="digitalrepository.postgres.lib.unb.ca provides database storage for The digitalrepository instance at UNB Libraries." \
